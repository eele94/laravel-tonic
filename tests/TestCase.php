...
class TestCase extends Orchestra
{
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        $migration = include __DIR__ . '/../database/migrations/create_tonic_verticals_table.php.stub';
        $migration->up();
        $migration = include __DIR__ . '/../database/migrations/create_tonic_offers_table.php.stub';
        $migration->up();
    }
}
